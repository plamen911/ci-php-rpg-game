...
```
Go to http://localhost/register and create a user
...
- https://www.codeigniter.com/userguide3/libraries/form_validation.html#re-populating-the-form
- http://www.bulfleet.com/newPortal.php
